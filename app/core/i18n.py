...
TRANSLATIONS = {
    "en": {
        ...
        "receipt_amount_not_found": "I could not confidently find the receipt amount.",
        "receipt_confidence": "Confidence",
        "receipt_empty_text": "I could not read text from this receipt.",
        "receipt_image_too_large": "The image is too large. Maximum size: {max_image_mb} MB.",
        "receipt_manual_hint": "Please enter the expense manually, for example: 250 taxi",
        "receipt_not_detected": "not detected",
        "receipt_not_found": "Receipt draft was already handled or expired.",
        "receipt_ocr_failed": "Could not recognize this receipt.",
        "receipt_ocr_unavailable": "Receipt OCR is currently unavailable.",
        "receipt_photo_processing": "Processing receipt photo...",
        "receipt_raw_preview_title": "Recognized text preview:",
        "receipt_recognized_confirm": "I found this receipt. Save it as an expense?",
    ...
    "ru": {
        ...
        "receipt_amount_not_found": "Не удалось уверенно найти сумму в чеке.",
        "receipt_confidence": "Уверенность",
        "receipt_empty_text": "Не удалось прочитать текст на этом чеке.",
        "receipt_image_too_large": "Фото слишком большое. Максимальный размер: {max_image_mb} МБ.",
        "receipt_manual_hint": "Введите расход вручную, например: 250 такси",
        "receipt_not_detected": "не найдено",
        "receipt_not_found": "Черновик чека уже обработан или устарел.",
        "receipt_ocr_failed": "Не удалось распознать этот чек.",
        "receipt_ocr_unavailable": "Распознавание чеков сейчас недоступно.",
        "receipt_photo_processing": "Обрабатываю фото чека...",
        "receipt_raw_preview_title": "Фрагмент распознанного текста:",
        "receipt_recognized_confirm": "Я нашел данные чека. Сохранить как расход?",
